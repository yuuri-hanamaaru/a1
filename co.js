(function () {
    ...
    initMembersData () {
        ...
        } else if (this.wikiId === 'renshu_suruka') {
            this.membersData = {
                ruka:         {yt: 'UCt30jJgChL8qeT9VPadidSw', tw: '', name: 'ルカ', tag: '', handle:'@ui_shig'},
                voisona:    {yt: 'UCoPUMQH-DiKlaJu1E_Sloqw', tw: '', name: '仲間', tag: '', handle:'@ui_roid'}
            }
        } else {
